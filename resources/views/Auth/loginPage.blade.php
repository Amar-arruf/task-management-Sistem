...
<body >
<section class="bg-orange-custom">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900">
          <h1 class="text-lg font-medium lg:font-bold md:text-2xl lg:text-4xl">TMS</h1>
      </a>
              ...
              <form class="space-y-4 md:space-y-6" action="{{route('auth')}}" method="post">
                @csrf
                  <div>
                      ...
                      <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="contoh@example.com" required="">
                  </div>
                  <div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Tidak punya akun Sekarang <a href="#" class="font-medium text-primary-600 hover:underline">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
